...
parsedInput.forEach((game) => {
  ...
  singleRoundBlues <= blueMax &&
    singleRoundReds <= redMax &&
    singleRoundGreens <= greenMax &&
    possibleOutcomes.push(Number(ID));
});
